...
exports.addAdmin = async (req, res, next) => {
  try {
    ...
    let hashedPassword;
    hashedPassword = await bcrypt.hash("krishna", 10);
...
// 	"department" : "C.S.E",
// 	"section" : "1",
// 	"studentMobileNumber" : "8318578564",
// 	"fatherMobileNumber" : "9415617994"
// }
...
exports.addStudent = async (req, res, next) => {
  try {
    ...
    let components = ["STU", batch, departmentHelper, helper];
...
exports.addFaculty = async (req, res, next) => {
  try {
    ...
    let date = new Date();
    const joiningYear = date.getFullYear();
    let components = ["FAC", joiningYear, departmentHelper, helper];
